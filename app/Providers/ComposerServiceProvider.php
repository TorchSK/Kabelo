...
class ComposerServiceProvider extends ServiceProvider {
    ...
    public function boot(ViewFactory $view)
    {
        ...
        $view->composer(['includes/*', 'cart.*','products.*','categories.products','home.cover', 'home.home','pages.contact','search.all','admin.eshop.category','admin.tabs'], 'App\Http\ViewComposers\AppnameComposer');
