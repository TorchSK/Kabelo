...
class ComposerServiceProvider extends ServiceProvider {
    ...
    public function boot(ViewFactory $view)
    {
        ...
        $view->composer(['includes/*', 'cart.*','products.*','categories.products','home.cover','pages.contact','search.all','admin.eshop.category'], 'App\Http\ViewComposers\AppnameComposer');
