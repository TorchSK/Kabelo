...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function()
{
	...
	Route::get('/settings/emails', 'AdminController@emails')->name('admin.settings.emails');

	Route::post('/settings/save', 'SettingController@bulkUpdate')->name('settings.bulkUpdate');
	...
	Route::put('/seo/tool/{id}', 'SeoController@seoToolUpdate')->name('seo.tool.update');
	...
	Route::put('/covers/setorder', 'AdminController@setCoverOrder')->name('admin.setCoverOrder');
	Route::put('/banners/setorder', 'AdminController@setBannerOrder')->name('admin.setBannerOrder');
...
Route::get('email/sentorder','UtilController@getSentOrderEmail');
Route::get('email/cancelorder','UtilController@getCancelOrderEmail');
