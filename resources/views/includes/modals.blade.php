...
<div class="ui mini modal" id="delete_catalogue_modal">
          
  <div class="header">
    Katalóg
  </div>
  <div class="content">
     Naozaj chcete vymazať katalóg
  </div>
  <div class="actions">
    <div class="ui red deny button">
      Nie
...
<div class="ui mini modal" id="change_order_modal_cancelled">
  ...
  <div class="ui mini modal" id="delete_method_modal">
            
    <div class="header">
      Zmazať meoodu
    </div>
    <div class="content">
       Naozaj chcete vymazať metodu
    </div>
    <div class="actions">
      <div class="ui red deny button">
        Níe
