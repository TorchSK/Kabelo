...
<html lang="en">
    ...
    <body style="width: 100%; margin: 0; padding: 0; font-family: 'Roboto',sans-serif; font-size: 15px; font-weight: 300;">
    ...
    <div style="padding: 50px; text-align: center;border-radius: 0 0 6px 6px;">
        ...
        <div style="margin: 15px 0; font-family: 'Roboto',sans-serif; font-size: 15px; font-weight: 300;">Ďakujeme za registráciu na eshope Dedraslovakia.sk</div>

        <div style="margin: 15px 0; margin-bottom: 35px; font-family: 'Roboto',sans-serif; font-size: 15px; font-weight: 300;">Svoju registráciu dokončite prosím klikom na tlačítko nižšie</div>
