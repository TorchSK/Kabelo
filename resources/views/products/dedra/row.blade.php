	 ...
	 <div class="labels">
		...
		@elseif ($product->image)
			@if($product->thumbnail_flag==1)
			 <img data-src="{{url((string)$product->image->thumb)}}" loading="lazy" class="ui image lazy" alt="{{$product->code}}-{{$product->name}}" style="max-height: 187px; display: inline-block;"/>
			@else
